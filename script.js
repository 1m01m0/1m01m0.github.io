...
const translations = {
  zh: {
    ...
    "nav.stack": "工具箱",
    "nav.contact": "联系",
    "hero.eyebrow": "2024-2028 / NJTECH / 计算机科学与技术",
    "hero.lede": "我来自南京工业大学（NJTECH），计算机科学与技术专业本科在读。研究方向为大语言模型（LLM）、自然语言处理（NLP）与强化学习（RL）。这里收藏我近期的项目、研究笔记与开源实验。",
    "hero.cta": "查看项目",
    "intro.text": "南京工业大学（NJTECH）计算机科学与技术专业学生，关注大语言模型（LLM）、NLP、强化学习、全栈工程与开发者体验。喜欢把模糊的想法整理成稳定的接口、克制的界面和可以复用的文档。",
    "stats.projects": "项目原型",
    "stats.notes": "技术笔记",
    "stats.research": "研究方向",
    "lab.title": "会动的技术展示台",
    ...
    "card.dash.link": "查看仓库",
    "card.edict.title": "三省六部制",
    "card.edict.desc": "基于 OpenClaw 的多智能体编排系统，9 个专业化 AI Agent 协作，配有实时仪表盘与完整审计追踪。",
    "card.edict.link": "查看仓库",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "个人 AI 助手，跨平台运行，支持多通道消息接入，本地优先的智能助理框架。",
    "card.openclaw.link": "查看仓库",
    "notes.title": "最近在想",
  ...
  en: {
    ...
    "nav.stack": "Stack",
    "nav.contact": "Contact",
    "hero.eyebrow": "2024-2028 / B.S. Computer Science / NJTECH",
    "hero.lede": "Undergraduate in Computer Science at Nanjing Tech University (NJTECH), focusing on Large Language Models (LLM), NLP, and Reinforcement Learning (RL). Here I collect recent projects, research notes, and open-source experiments.",
    "hero.cta": "View Projects",
    "intro.text": "Computer Science student at Nanjing Tech University (NJTECH), focused on Large Language Models (LLM), NLP, Reinforcement Learning, full-stack engineering, and developer experience. I enjoy turning vague ideas into stable interfaces, restrained UIs, and reusable documentation.",
    ...
    "card.edict.title": "EDICT",
    "card.edict.desc": "A multi-agent orchestration system built on OpenClaw — 9 specialized AI agents collaborating with real-time dashboard and full audit trails.",
    "card.edict.link": "View Repo",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "Personal AI assistant running on your own devices — cross-platform, multi-channel, local-first intelligent assistant framework.",
    "card.openclaw.link": "View Repo",
  ...
  ko: {
    ...
    "nav.stack": "도구",
    "nav.contact": "연락",
    "hero.eyebrow": "2024-2028 / NJTECH / 컴퓨터공학",
    "hero.lede": "난징공업대학교(NJTECH) 컴퓨터공학과 학부생으로, 대규모 언어 모델(LLM), NLP, 강화 학습(RL)을 연구합니다. 여기에는 최근 프로젝트, 연구 노트, 오픈소스 실험을 모아두었습니다.",
    "hero.cta": "프로젝트 보기",
    "intro.text": "난징공업대학교(NJTECH) 컴퓨터공학과 학생으로 대규모 언어 모델(LLM), NLP, 강화 학습, 풀스택 엔지니어링, 개발자 경험에 집중합니다. 모호한 아이디어를 안정적인 인터페이스, 절제된 UI, 재사용 가능한 문서로 정리하는 것을 좋아합니다.",
    ...
    "card.edict.title": "EDICT·삼성육부제",
    "card.edict.desc": "OpenClaw 기반 멀티 에이전트 오케스트레이션 시스템 — 9개의 전문 AI 에이전트가 실시간 대시보드와 감사 추적 기능으로 협업합니다.",
    "card.edict.link": "저장소 보기",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "자신의 기기에서 실행되는 개인 AI 비서 — 크로스플랫폼, 멀티채널, 로컬 우선 지능형 비서 프레임워크.",
    "card.openclaw.link": "저장소 보기",
    "notes.title": "최근 생각",
  ...
  ja: {
    ...
    "nav.stack": "ツール",
    "nav.contact": "連絡",
    "hero.eyebrow": "2024-2028 / NJTECH / コンピュータサイエンス",
    "hero.lede": "南京工業大学（NJTECH）コンピュータサイエンス専攻の学部生として、大規模言語モデル（LLM）、NLP、強化学習（RL）を研究しています。最近のプロジェクト、研究ノート、オープンソース実験を掲載しています。",
    "hero.cta": "プロジェクトを見る",
    "intro.text": "南京工業大学（NJTECH）コンピュータサイエンス専攻の学生として、大規模言語モデル（LLM）、NLP、強化学習、フルスタックエンジニアリング、開発者体験に注力しています。漠然としたアイデアを安定したインターフェース、簡潔なUI、再利用可能なドキュメントに整理することが好きです。",
    ...
    "card.edict.title": "EDICT·三省六部制",
    "card.edict.desc": "OpenClaw ベースのマルチエージェントオーケストレーションシステム — 9つの専門 AI エージェントがリアルタイムダッシュボードと監査証跡で連携します。",
    "card.edict.link": "リポジトリを見る",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "自分のデバイスで動作するパーソナル AI アシスタント — クロスプラットフォーム、マルチチャンネル、ローカルファーストのインテリジェントアシスタントフレームワーク。",
    "card.openclaw.link": "リポジトリを見る",
  ...
  de: {
    ...
    "nav.stack": "Werkzeuge",
    "nav.contact": "Kontakt",
    "hero.eyebrow": "2024-2028 / B.S. Informatik / NJTECH",
    "hero.lede": "Bachelor-Student der Informatik an der Nanjing Tech University (NJTECH) mit Schwerpunkt auf Large Language Models (LLM), NLP und Reinforcement Learning (RL). Hier sammle ich aktuelle Projekte, Forschungsnotizen und Open-Source-Experimente.",
    "hero.cta": "Projekte ansehen",
    "intro.text": "Informatik-Student an der Nanjing Tech University (NJTECH) mit Fokus auf Large Language Models (LLM), NLP, Reinforcement Learning, Full-Stack-Engineering und Entwicklererfahrung. Ich verwandle vage Ideen gerne in stabile Interfaces, reduzierte UIs und wiederverwendbare Dokumentation.",
    ...
    "card.edict.title": "EDICT",
    "card.edict.desc": "Ein auf OpenClaw basierendes Multi-Agenten-Orchestrierungssystem — 9 spezialisierte KI-Agenten mit Echtzeit-Dashboard und vollständigen Audit-Trails.",
    "card.edict.link": "Repo ansehen",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "Persönlicher KI-Assistent auf eigenen Geräten — plattformübergreifend, mehrkanalfähig, lokal-first intelligentes Assistenten-Framework.",
    "card.openclaw.link": "Repo ansehen",
  ...
  es: {
    ...
    "hero.eyebrow": "2024-2028 / Lic. en Informática / NJTECH",
    "hero.lede": "Estudiante de grado en Informática en la Universidad de Tecnología de Nanjing (NJTECH), enfocado en Modelos de Lenguaje a Gran Escala (LLM), NLP y Aprendizaje por Refuerzo (RL). Aquí guardo proyectos recientes, notas de investigación y experimentos de código abierto.",
    "hero.cta": "Ver proyectos",
    "intro.text": "Estudiante de Informática en la Universidad de Tecnología de Nanjing (NJTECH), enfocado en Modelos de Lenguaje a Gran Escala (LLM), NLP, Aprendizaje por Refuerzo, ingeniería full-stack y experiencia del desarrollador. Me gusta transformar ideas difusas en interfaces estables, UI minimalistas y documentación reutilizable.",
    ...
    "card.edict.title": "EDICT",
    "card.edict.desc": "Sistema de orquestación multi-agente basado en OpenClaw — 9 agentes de IA especializados con panel en tiempo real y auditoría completa.",
    "card.edict.link": "Ver repositorio",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "Asistente personal de IA ejecutándose en tus propios dispositivos — multiplataforma, multicanal, framework de asistente inteligente local primero.",
    "card.openclaw.link": "Ver repositorio",
  ...
  fr: {
    ...
    "nav.stack": "Outils",
    "nav.contact": "Contact",
    "hero.eyebrow": "2024-2028 / Licence Informatique / NJTECH",
    "hero.lede": "Étudiant en licence d'Informatique à l'Université de Technologie de Nanjing (NJTECH), spécialisé en Grands Modèles de Langage (LLM), NLP et Apprentissage par Renforcement (RL). C'est ici que je rassemble mes projets récents, notes de recherche et expériences open source.",
    "hero.cta": "Voir les projets",
    "intro.text": "Étudiant en Informatique à l'Université de Technologie de Nanjing (NJTECH), spécialisé en Grands Modèles de Langage (LLM), NLP, Apprentissage par Renforcement, développement full-stack et expérience développeur. J'aime transformer des idées floues en interfaces stables, UI épurées et documentation réutilisable.",
    "stats.projects": "Prototypes",
    ...
    "card.edict.title": "EDICT",
    "card.edict.desc": "Système d'orchestration multi-agents basé sur OpenClaw — 9 agents IA spécialisés collaborant avec tableau de bord en temps réel et pistes d'audit complètes.",
    "card.edict.link": "Voir le dépôt",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "Assistant IA personnel fonctionnant sur vos propres appareils — multiplateforme, multicanal, framework d'assistant intelligent local d'abord.",
    "card.openclaw.link": "Voir le dépôt",
  ...
  "zh-TW": {
    ...
    "nav.stack": "工具箱",
    "nav.contact": "聯絡",
    "hero.eyebrow": "2024-2028 / NJTECH / 計算機科學與技術",
    "hero.lede": "我來自南京工業大學（NJTECH），計算機科學與技術專業本科在讀。研究方向為大語言模型（LLM）、自然語言處理（NLP）與強化學習（RL）。這裡收藏我近期的專案、研究筆記與開源實驗。",
    "hero.cta": "查看專案",
    "intro.text": "南京工業大學（NJTECH）計算機科學與技術專業學生，關注大語言模型（LLM）、NLP、強化學習、全端工程與開發者體驗。喜歡把模糊的想法整理成穩定的介面、克制的界面和可以複用的文件。",
    "stats.projects": "專案原型",
    "stats.notes": "技術筆記",
    "stats.research": "研究方向",
    "lab.title": "會動的技術展示台",
    ...
    "card.dash.link": "查看倉庫",
    "card.edict.title": "三省六部制",
    "card.edict.desc": "基於 OpenClaw 的多智能體編排系統，9 個專業化 AI Agent 協作，配有即時儀表板與完整審計追蹤。",
    "card.edict.link": "查看倉庫",
    "card.openclaw.title": "OpenClaw",
    "card.openclaw.desc": "個人 AI 助手，跨平台運行，支援多通道訊息接入，本地優先的智能助理框架。",
    "card.openclaw.link": "查看倉庫",
    "notes.title": "最近在想",
