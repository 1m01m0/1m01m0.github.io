...
const translations = {
  zh: {
    ...
    "summary.title": "个人简介",
    "summary.text": "南京工业大学（NJTECH）计算机科学与技术专业学生，关注大语言模型（LLM）、NLP、强化学习、全栈工程与开发者体验。喜欢把模糊的想法整理成稳定的接口、克制的界面和可以复用的文档。",
    "stats.projects": "项目原型",
    "stats.notes": "技术笔记",
    "stats.research": "研究方向",
  ...
  en: {
    ...
    "summary.text": "Computer Science student at Nanjing Tech University (NJTECH), focused on Large Language Models (LLM), NLP, Reinforcement Learning, full-stack engineering, and developer experience. I enjoy turning vague ideas into stable interfaces, restrained UIs, and reusable documentation.",
    ...
    "education.degree": "B.S. in Computer Science & Technology",
  ...
  ko: {
    ...
    "summary.eyebrow": "Summary",
    "summary.title": "자기소개",
    "summary.text": "난징공업대학교(NJTECH) 컴퓨터공학과 학생으로 대규모 언어 모델(LLM), NLP, 강화 학습, 풀스택 엔지니어링, 개발자 경험에 집중합니다. 모호한 아이디어를 안정적인 인터페이스, 절제된 UI, 재사용 가능한 문서로 정리하는 것을 좋아합니다.",
  ...
  ja: {
    ...
    "summary.eyebrow": "Summary",
    "summary.title": "自己紹介",
    "summary.text": "南京工業大学（NJTECH）コンピュータサイエンス専攻の学生として、大規模言語モデル（LLM）、NLP、強化学習、フルスタックエンジニアリング、開発者体験に注力しています。漠然としたアイデアを安定したインターフェース、簡潔なUI、再利用可能なドキュメントに整理することが好きです。",
    ...
    "education.degree": "コンピュータサイエンス学士",
  ...
  de: {
    ...
    "summary.text": "Informatik-Student an der Nanjing Tech University (NJTECH) mit Fokus auf Large Language Models (LLM), NLP, Reinforcement Learning, Full-Stack-Engineering und Entwicklererfahrung. Ich verwandle vage Ideen gerne in stabile Interfaces, reduzierte UIs und wiederverwendbare Dokumentation.",
    ...
    "education.school": "Nanjing Tech University (NJTECH)",
    "education.degree": "B.S. Informatik",
  ...
  "zh-TW": {
    ...
    "summary.eyebrow": "Summary",
    "summary.title": "個人簡介",
    "summary.text": "南京工業大學（NJTECH）計算機科學與技術專業學生，關注大語言模型（LLM）、NLP、強化學習、全端工程與開發者體驗。喜歡把模糊的想法整理成穩定的介面、克制的界面和可以複用的文件。",
    "stats.projects": "專案原型",
    "stats.notes": "技術筆記",
    "stats.research": "研究方向",
    "education.eyebrow": "Education",
